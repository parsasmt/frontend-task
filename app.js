document.addEventListener('DOMContentLoaded', () => {
    ...
    editItemForm.addEventListener('submit', event => {
        ...
        cells[0].textContent = event.target.first_name.value;
        cells[1].textContent = event.target.last_name.value;
        cells[2].textContent = event.target.social_security_number.value;
